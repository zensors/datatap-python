...
from datatap.api.entities import Api
from datatap.torch import create_dataloader

def main():
    # If [DATATAP_API_KEY] is not in your environment, then pass it as the first argument
    api = Api()
    ...
    loader = create_dataloader(ds.latest_version, "training", class_mapping = class_map)
