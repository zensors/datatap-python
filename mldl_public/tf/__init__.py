"""
The `tf` module provides utilities for using MLDL with Tensorflow.

Please note that if you want to be able to use this module, you will
either need to install Tensorflow manually, or install MLDL with the
tensorflow extra:

```bash
pip install 'mldl_public[tf]'
```
...
from mldl_public.tf import create_dataset
